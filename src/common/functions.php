...
function isAuth()
{
    if (!empty($_SESSION['auth'])) {
        if ($_SESSION['user_role'] == 'admin') {
            header("Location: /src/users/admins/profile_admin.php");
        } else if ($_SESSION['user_role'] == 'teacher') {
            header("Location: /src/users/teachers/profile_teacher.php");
        } else {
            header("Location: /src/users/students_parents/profile_student_parent.php");
        }
        exit;
    }
}
...
{
    if ($_SESSION['user_role'] == 'admin') {
        return ('<a href="/src/users/admins/profile_admin.php">Профиль</a>');
    } else if ($_SESSION['user_role'] == 'teacher') {
        return ('<a href="/src/users/teachers/profile_teacher.php">Профиль</a>');
    } else {
        return ('<a href="/src/users/students_parents/profile_student_parent.php">Профиль</a>');
    }
}
...
{
    if ($_SESSION['user_role'] == 'admin') {
        return ('<a href="/src/polls/polls.php">Список опросов</a>');
    } else if ($_SESSION['user_role'] == 'teacher') {
        return ('<a href="/src/polls/polls_teacher.php">Список опросов</a>');
    } else {
        return '';
    }
}
...
{
    if ($_SESSION['user_role'] == 'admin') {
        return ('<a href="/src/polls/poll_attempts.php">Результаты прохождения опросов</a>');
    } else if ($_SESSION['user_role'] == 'teacher') {
        return ('<a href="/src/polls/poll_attempts.php">Результаты прохождения опросов</a>');
    } else {
        return '';
