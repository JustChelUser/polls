...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($loginErr === '' && $passErr === '' && $flagValidation === 0) {
        ...
        if (password_verify($pass, $user['password'])) {
            ...
            if ($user['role'] == 'admin') {
                header("Location: ../users/admins/profile_admin.php");
            } else if ($user['role'] == 'teacher') {
                header("Location: ../users/teachers/profile_teacher.php");
            } else {
                header("Location: ../users/students_parents/profile_student_parent.php");
            }
        } else {
